...
{  
  ...
  OLED_ShowSignedNum(3, 5, icm20602_gyro[1], 2);
	...
	OLED_ShowSignedNum(4, 1, icm20602_accel[0], 2);
	OLED_ShowSignedNum(5, 1, icm20602_accel[0]+icm20602_gyro[2]+icm20602_gyro[1], 2);
//	OLED_ShowSignedNum(4, 5, icm20602_accel[1], 2);
//	OLED_ShowSignedNum(4, 9, icm20602_accel[2], 2);
//	OLED_ShowSignedNum(1, 9, icm20602_temp, 2);
}
